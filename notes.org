...
** BOON
   ...
   has type =Boon=. The form =( boon:boon {value}:Boon )= can be used to disambiguate how ={value}=
   should be interpreted, as BOON reuse existing core BULK types when they are appropriate.
